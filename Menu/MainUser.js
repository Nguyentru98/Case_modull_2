...
const ManageAlbum_1 = require("../Manage/ManageAlbum");
const ManageSong_1 = require("../Manage/ManageSong");
const ManageUser_1 = require("../Manage/ManageUser");
let input = require('readline-sync');
let mU = new ManageUser_1.ManageUser();
let mA = new ManageAlbum_1.ManageAlbum();
let mS = new ManageSong_1.ManageSong();
// main
const REGISTER = 1;
const LOGIN = 2;
const EXIT = 0;
